namespace :'51' do
  ...
  task :update => :environment do
    ...
    Rails.logger.info "#{ Time.now }: update *.src.rpm from 5.1 to database"
    ...
    Rails.logger.info "#{ Time.now }: update *.i586.rpm/*.noarch.rpm/*.x86_64.rpm from 5.1 to database"
  ...
  #   require 'open-uri'
  #   Rails.logger.info "#{ Time.new }: import teams"
