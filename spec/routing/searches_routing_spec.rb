...
describe SearchesController do
  describe "routing" do
    it "should route /search?utf8=yes&branch=Sisyphus&query=openbox to home#index" do
    ...
    it "should route /en/search?utf8=yes&branch=Sisyphus&query=openbox to home#index" do
